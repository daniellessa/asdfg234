 ...
 */
public class MonthLoader implements ViewLoader {
    ...
    @Override
    public List<? extends ViewEvent> onLoad(int periodIndex){
    ...
    public interface MonthChangeListener {
         ...
         */
        List<? extends ViewEvent> onMonthChange(int newYear, int newMonth);
    }
}
