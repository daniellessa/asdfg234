...
import br.com.dalecom.agendamobile.utils.DrawableCalendarEvent;

public class CalendarProfessionalActivity extends AppCompatActivity implements CalendarPickerController{
    ...
    private void mockList(List<CalendarEvent> eventList) {
        ...
        DrawableCalendarEvent event3 = new DrawableCalendarEvent("Daniel Lessa", "", DateHelper.hourToString(startTime3)+ " às " +DateHelper.hourToString(endTime3),
                ContextCompat.getColor(this, R.color.colorPrimaryDark), startTime3, endTime3, false, R.drawable.ic_alarm_black_48dp);
